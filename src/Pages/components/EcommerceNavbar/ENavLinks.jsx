      ...
      <>
        {navlinks.map((link, index) => (
          <div>
            ...
            <h1 className="cursor-pointer hover:text-blue-800 group text-[1rem] md:text-[1.1rem] font-semibold 
            ...
            {link.submenu && link.sublinks && (
              <div>
                <div className="hidden group-hover:md:block hover:block  absolute top-14">
                {/* <div className="">
                    <div
